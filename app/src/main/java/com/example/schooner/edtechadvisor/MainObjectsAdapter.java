...
public class MainObjectsAdapter extends RecyclerView.Adapter <ObjectViewHolder> {

    private List<Object> tools;
    private Context context;

    public MainObjectsAdapter(List<Object> tools, Context context){
            this.tools=tools;
    ...
    public ObjectViewHolder onCreateViewHolder(ViewGroup parent,int viewType){
            View view=LayoutInflater.from(parent.getContext()).inflate(R.layout.main_card_view_object,parent,false);
